...
(function () {
  ...
  // 命令表数据已整体移除 (v1.5): 命令速查以 txt 文章形式存于 理学文章.js
  ...
  const 核心 = {
    ...
    解析路由, 跳转, 生成加速,
    提示, 复制文本,
    收藏列表, 历史列表, 评论列表, 自建列表, 点赞表, 浏览表,
    是否收藏, 点赞数, 浏览数, 评论数, 某键评论,
    切换收藏, 添加点赞, 记录浏览, 记录历史, 添加评论,
    全部文章,
  };
